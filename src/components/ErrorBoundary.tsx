    ...
    return (
      <main className="grid min-h-screen place-items-center bg-slate-950 p-6 text-slate-300">
        <div className="max-w-md border border-rose-400/20 bg-slate-900 p-5">
          <h1 className="text-base font-medium text-slate-100">Wardmap could not continue</h1>
          ...
          <button
            className="mt-4 bg-slate-100 px-3 py-2 text-xs font-medium text-slate-950 hover:bg-white"
            type="button"
